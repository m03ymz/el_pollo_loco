 ...
 */
class EndbossAttack3 extends MovableObject {
    IMAGES = [
        'img/13_endboss_attack/4/1.png',
        'img/13_endboss_attack/4/2.png',
        'img/13_endboss_attack/4/3.png',
        'img/13_endboss_attack/4/4.png',
        'img/13_endboss_attack/4/5.png'
    ];

    IMAGES_EXPLOSION = [
        'img/13_endboss_attack/4/6.png',
        'img/13_endboss_attack/4/7.png',
        'img/13_endboss_attack/4/8.png',
        'img/13_endboss_attack/4/9.png',
        'img/13_endboss_attack/4/10.png'
    ];
     ...
     */
    constructor(x, y) {
        super().loadImage('img/13_endboss_attack/4/1.png');
